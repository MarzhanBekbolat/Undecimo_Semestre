...
public:
  ...
  bool m_lock;
  int m_timeout;
  double lat,laten,k,laten_total,thro,throu,through_total,count,tdume,tdumetot,tdumenonblock, tdumeinir, tdumefinr, tdumer, tdumeiniw, tdumefinw, tdumew;// variables globales para el main
