...
SC_MODULE(simple_bus_test)
{
  ...
  {
    // create instances
    master_b = new simple_bus_master_blocking("master_b", 1, 0x4c, false, 10);
    master_b1 = new simple_bus_master_blocking("master_b", 2, 0x6c, false, 14);
    master_nb = new simple_bus_master_non_blocking("master_nb", 3, 0x38, false, 12);
    master_nb1 = new simple_bus_master_non_blocking("master_nb", 4, 0x52, false, 13);
