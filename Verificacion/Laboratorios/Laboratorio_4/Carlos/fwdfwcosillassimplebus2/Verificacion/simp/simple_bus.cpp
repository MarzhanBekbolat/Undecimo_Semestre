...
//métrica para calcular el nievl de utilización del bus

  utilizacion = (100 * ocupado)/(sin_uso + ocupado);
  sb_fprintf(stdout, "%g\tNivel de utilizacion del Bus:\t%g%\n", sc_time_stamp().to_double(), utilizacion);
