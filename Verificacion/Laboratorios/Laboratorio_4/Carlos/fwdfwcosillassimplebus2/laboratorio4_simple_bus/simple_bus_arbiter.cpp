...
sb_fprintf(stdout, "%g\tNivel de utilización_ARBITRO:\t%g%\n", sc_time_stamp().to_double(), contador);
contador=cont2+1;  ///creamos un objeto de la clase nivel de utilizacion para
